...
<body>
    <!-- include generate warning error  and script executed continue if same file included more than one times its rpeated-->
...
?>
<!-- require generate fatal error  and script stopped to executed continue if same file included more than one times its rpeated-->
<?php 


// require("logggin_logic.php");
// require("logiggn_logic.php");
